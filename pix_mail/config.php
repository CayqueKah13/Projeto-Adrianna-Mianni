<?php
	$mail_type = "ce";
	//-----------------------------------------------------------------------------------------
    $to_Email       = "contato@adriannamianni.com.br"; //Replace with recipient email address
    $subject        = 'E-Mail do Formulário de Contato'; //Subject line for emails

    // your recaptcha secret key
    $secret = "6Lc_TPskAAAAAK4d5mwDysdaJOC9ZX0yzB6FTIAM";      // Add your reCAPTCHA secret key
    //----------------------------------------------------------    -------------------------------
    ...
    // SMTP Settings
    define('SMTP_HOST', 'mail.adriannamianni.com.br');
    define('SMTP_USER', 'contato@adriannamianni.com.br');
    define('SMTP_PASS', 'adriann@2023');
