...
if($_POST)
{
	...
	function sendSendy($mailSubscribe, $the_list, $merge_vars=NULL, $language, $lang){
		if(defined('Mailwizz_apiUrl') && defined('Mailwizz_publicKey') && defined('Mailwizz_privateKey')) {
			...
			$config = [
				'sendyUrl' => 'http://pixfort.local/sendy', // Your Sendy installation URL (without trailing slash).
				'apiKey'   => 'vRYtzmtQPkImy8tbpR9HvbYNAn5q54kL', // Your API key. Available in Sendy Settings.
				'listId'   => '7Ug2TkToHs09j09QDJphjg',
			];
